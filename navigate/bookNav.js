...
export default function BookNav(){
    return(
      <Tab.Navigator >
        <Tab.Screen name = "Main" component = {Bookmark1} options={{headerShown: false,unmountOnBlur:true,tabBarStyle:{display:"none"}}}/>
        <Tab.Screen name = "Hverse1" component = {Hverse} options={{headerShown: false,unmountOnBlur:true,tabBarStyle:{display:"none"}}}/>
      </Tab.Navigator>
    )
}
